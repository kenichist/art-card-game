 ...
 */
function getMatchingData(itemId, collectorId) {
 ...
 */
function setMatchingData(itemId, collectorId, value, attributes) {
  // Ensure IDs are within valid range
  if (itemId < 1 || itemId > 72 || collectorId < 1 || collectorId > 30) {
 ...
 */
function getCollectorMatches(collectorId) {
 ...
 */
function getFullMatchingMatrix() {
